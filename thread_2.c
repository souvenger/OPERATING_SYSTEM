//The thread is passed more than one input from the main process.
//For passing multiple inputs we need to create
// structure and include all the variables that are to be passed in this structure.
#include <stdio.h>
#include <pthread.h>
struct arg_struct
